  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger asChild>
        <button
          className="inline-flex h-9 items-center gap-2 rounded-[var(--radius-btn)] border bg-transparent px-3 text-sm text-[var(--muted-foreground)] transition-colors hover:bg-[var(--accent)] hover:text-[var(--foreground)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2"
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <div className="flex items-center border-b px-4">
            <Search className="h-4 w-4 text-[var(--muted-foreground)]" strokeWidth={1.5} aria-hidden />
            <input
              autoFocus
              type="text"
              value={query}
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="text-xs text-[var(--muted-foreground)]">{r.sectionTitle}</div>

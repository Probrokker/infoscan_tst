      ...
      <nav>
        {tree.map((section) => (
          <div key={section.sectionId} className="mb-6">
            <h2 className="mb-2 px-2 text-xs font-semibold uppercase tracking-wide text-[var(--muted-foreground)]">
              <Link
            ...
            {section.pages.length === 0 ? (
              <p className="px-2 text-xs italic text-[var(--muted-foreground)]">

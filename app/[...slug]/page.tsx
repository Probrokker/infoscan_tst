    ...
    <div className="mx-auto flex max-w-screen-2xl gap-8 px-4 sm:px-6 lg:px-8">
      ...
      <article className="min-w-0 flex-1 py-8 lg:py-12">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-zinc max-w-none dark:prose-invert prose-headings:scroll-mt-20 prose-pre:rounded-[var(--radius-card)] prose-pre:border prose-code:font-mono">
            {content}
          </div>

            ...
            <CardContent>
              ...
              {!running && !result && (
                <Callout kind="info" title="Шаблон ещё не запускался">
                  ...
                  Эмулятор возьмёт текущий шаблон из конструктора и покажет, что именно ушло бы в
                  WMS клиента.
                </Callout>
              )}
              {result && result.ok && (
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center gap-2 text-xs">
                    <span className="font-mono text-[var(--muted-foreground)] uppercase">
                      transport:
                    </span>
              ...
              <div className="mt-3 text-xs text-[var(--muted-foreground)]">
                <Button asChild variant="link" size="sm" className="h-auto p-0">
                  <Link href="/integration/builder">Редактировать шаблон в конструкторе →</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
